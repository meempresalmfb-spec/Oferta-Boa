...
// Adaptado de Uiverse.io (vinodjangid07) — botão "receber ofertas" com sino.
export type NotifyButtonProps = {
  children?: ReactNode
  href?: string
}

export function NotifyButton({ children = 'Receber ofertas', href = '#' }: NotifyButtonProps) {
  return (
    <a className={styles.button} href={href}>
      <svg className={styles.bell} viewBox="0 0 448 512" aria-hidden="true">
        <path d={BELL} />
      </svg>
      <span>{children}</span>
